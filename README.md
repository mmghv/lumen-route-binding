...
[![Lumen Version](https://img.shields.io/badge/Lumen-5.0%20to%205.6-orange.svg)](https://github.com/laravel/lumen) 
...
This package Adds support for `Route Model Binding` in Lumen (5.0 to 5.6).
